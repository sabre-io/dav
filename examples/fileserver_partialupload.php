...
// Create the root node, Extended file system driver
$root = new Sabre_DAV_FSExt_Directory($publicDir);
...
// Support for PATCH (partial upload)
$patch = new Sabre_DAV_PartialUpdate_Plugin();
$server->addPlugin($patch);
