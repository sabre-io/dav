...
<d:propfind xmlns:d="DAV:">
  <d:prop>
    <d:supported-report-set />
        ...
        $this->assertEquals(207, $this->response->getStatus(), 'We expected a multi-status response. Full response body: ' . $this->response->getBody());
...
<d:propfind xmlns:d="DAV:">
  <d:prop>
    <d:supported-report-set />
        ...
        $this->assertEquals(1, count($data), 'We expected 1 \'x:myreport\' element. Full body: ' . $this->response->getBody());
        ...
        $this->assertEquals(1, count($data), 'We expected 1 \'d:anotherreport\' element. Full body: ' . $this->response->getBody());
