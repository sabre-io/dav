...
<d:propfind xmlns:d="DAV:">
  <d:prop>
    <d:supported-report-set />
        ...
        $this->assertEquals(207, $this->response->status, 'We expected a multi-status response. Full response body: '.$this->response->getBodyAsString());
...
<d:propfind xmlns:d="DAV:">
  <d:prop>
    <d:supported-report-set />
        ...
        $this->assertEquals(1, count($data), 'We expected 1 \'x:myreport\' element. Full body: '.$this->response->getBodyAsString());
        ...
        $this->assertEquals(1, count($data), 'We expected 1 \'d:anotherreport\' element. Full body: '.$this->response->getBodyAsString());
