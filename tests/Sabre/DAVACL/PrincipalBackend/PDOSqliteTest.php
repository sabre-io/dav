...
class Sabre_DAVACL_PrincipalBackend_PDOSQLiteTest extends Sabre_DAVACL_PrincipalBackend_AbstractPDOTest {
    ...
    function getPDO() {
        ...
        $pdo->query('CREATE TABLE principals (uri TEXT, digesta1 TEXT, email VARCHAR(80), displayname VARCHAR(80))');
        $pdo->query('INSERT INTO principals VALUES ("principals/user","hash","user@example.org","User")');
