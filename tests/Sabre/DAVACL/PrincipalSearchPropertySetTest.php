...
<d:principal-search-property-set xmlns:d="DAV:" />';
        ...
        $this->assertEquals(400, $server->httpResponse->getStatus());
        $this->assertEquals([
...
<d:principal-search-property-set xmlns:d="DAV:"><d:ohell /></d:principal-search-property-set>';
        ...
        $this->assertEquals(400, $server->httpResponse->getStatus(), $server->httpResponse->getBody());
        $this->assertEquals([
            'X-Sabre-Version' => [DAV\Version::VERSION],
            'Content-Type'    => ['application/xml; charset=utf-8'],
        ], $server->httpResponse->getHeaders());
...
<d:principal-search-property-set xmlns:d="DAV:"/>';
        ...
        $this->assertEquals(200, $server->httpResponse->getStatus(), $server->httpResponse->getBody());
        $this->assertEquals([
            'X-Sabre-Version' => [DAV\Version::VERSION],
            'Content-Type'    => ['application/xml; charset=utf-8'],
        ], $server->httpResponse->getHeaders());
